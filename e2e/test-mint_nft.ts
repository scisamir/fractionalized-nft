...
import mintNftBlueprint from "../test-mint_nft_onchain/plutus.json" with { type: "json" };
import { txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos } from "./setup.js";

// mint_nft Validator
const mintNftValidator = mintNftBlueprint.validators.filter((val) => val.title.includes('mint_nft.mint'));
if (!mintNftValidator) {
